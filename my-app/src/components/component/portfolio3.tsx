    ...
    <div className="flex flex-col min-h-screen bg-blue-900">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-6">
          ...
          <a className="text-sm font-medium hover:underline underline-offset-4 text-white" href="#pikk">
            Pikk
          </a>
          <a className="text-sm font-medium hover:underline underline-offset-4 text-white" href="#kukk">
            Kukk
          </a>
          <a className="text-sm font-medium hover:underline underline-offset-4 text-white" href="#fitte">
            Fitte
          </a>
        </nav>
      </header>
