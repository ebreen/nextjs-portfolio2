 ...
 * @see https://v0.dev/t/4SH5SY6COKH
 */
    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center" href="#">
          <span className="text-lg font-bold">Eirik Breen</span>
        </Link>
            ...
            <div className="grid gap-6 lg:gap-12 xl:gap-16 mt-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="rounded-lg overflow-hidden shadow-lg">
                ...
                <CardContent className="p-4">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Short description of project 1.</p>
                </CardContent>
              </Card>
              <Card className="rounded-lg overflow-hidden shadow-lg">
                <CardHeader>
                ...
                <CardContent className="p-4">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Short description of project 2.</p>
                </CardContent>
              </Card>
              <Card className="rounded-lg overflow-hidden shadow-lg">
                <CardHeader>
                ...
                <CardContent className="p-4">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Short description of project 3.</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800" id="experience">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 lg:gap-12 xl:gap-16 mt-8 grid-cols-1 sm:grid-cols-2">
              <Card className="rounded-lg overflow-hidden shadow-lg">
                <CardContent className="p-4">
                  <h3 className="text-xl font-bold">Company Name 1</h3>
              ...
              <Card className="rounded-lg overflow-hidden shadow-lg">
                <CardContent className="p-4">
                  <h3 className="text-xl font-bold">Company Name 2</h3>
                  <p className="text-gray-500 dark:text-gray-400">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© Eirik Breen. All rights reserved.</p>
      </footer>
    </div>
  )
}
